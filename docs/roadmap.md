...
Patch **v1.1.2** (tagged 2026-09-12, released 2026-09-14:
<https://github.com/hnkNkm/flareadm/releases/tag/v1.1.2>) always surfaces the
authorize URL — printed on stderr before the browser handoff, and on stdout with `--no-browser` —

...
**Status:** v0.3.0 released (2026-09-10); v0.4 delivered; v0.5 in progress. Command surface, exit codes and normalized output are usable. See the [roadmap](roadmap.md).

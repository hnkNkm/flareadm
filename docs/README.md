...
**Status:** v0.1 complete (unreleased); v0.2 in progress (slices 1 and 2 delivered: SSL/TLS and certificates, rules engine). Command surface, exit codes and normalized output are usable; releases are not yet published. See the [roadmap](roadmap.md).
